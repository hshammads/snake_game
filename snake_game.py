...
def draw_objects():
    ...
    pygame.draw.rect(win, white, pygame.Rect(food_pos[0], food_pos[1], BLOCK_SIZE, BLOCK_SIZE))
    # Render the score
...
def game_over_screen():
    ...
    restart_text = score_font.render(f"Hit r to restart game", True, white)
